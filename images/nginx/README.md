...
| Tag | State | OS |
|---|---|---|
| [`v2.2`, `v2.3-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.3/images/nginx) | Stable | Alpine 3.12 |
| [`v2.3`, `v2.2-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.2/images/nginx) | Security fixes only | Alpine 3.11 |

...
| Tag | State | OS |
|---|---|---|
| [`v2.3`, `v2.3-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.3/images/nginx) | Stable | Alpine 3.12 |
| [`v2.2`, `v2.2-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.2/images/nginx) | Security fixes only | Alpine 3.12 |

There will be no `latest` tag available in future. Using a `latest` can cause a lot of troubles, especially if you are using Docker in production. Please use the current stable tag (`v2.3`) instead.
...
```
docker run -p 80:80 -v [YOUR-PROJECT-ROOT]:/var/www whatwedo/nginx:v2.3
```

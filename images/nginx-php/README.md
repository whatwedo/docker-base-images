[![Docker Pulls](https://img.shields.io/docker/pulls/whatwedo/nginx-php.svg)](https://cloud.docker.com/u/whatwedo/repository/docker/whatwedo/nginx-php)
...
|---|---|---|---|
| [`v2.2`, `v2.2-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.2/images/nginx-php) | Stable | Alpine 3.11 |
| [`v2.1`, `v2.1-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.1/images/nginx-php) | Security fixes only | Alpine 3.10 |
| [`v2.0`, `v2.0-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.0/images/nginx-php) | Deprecated | Alpine 3.9 |

There is no `latest` latest tag available. Using a `latest` tag can cause a lot of troubles, especially if you are using Docker in production. Please use the current stable tag (`v2.2`) instead.


## Usage

```
docker run -p 80:80 -v [YOUR-PROJECT-ROOT]:/var/www whatwedo/nginx-php:v2.2
```

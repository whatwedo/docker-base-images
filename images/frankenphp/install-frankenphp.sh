...
ZTS_KEY_FPR=84C55642FCEBE5C81B8ECAF984A79E3970A7B254
import-apt-key.sh \
    https://pkg.henderkes.com/api/packages/84/debian/repository.key \
    "$ZTS_KEY_FPR" /etc/apt/keyrings/php-zts.gpg
echo 'deb [signed-by=/etc/apt/keyrings/php-zts.gpg] https://pkg.henderkes.com/api/packages/84/debian php-zts main' \

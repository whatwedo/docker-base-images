[![Docker Pulls](https://img.shields.io/docker/pulls/whatwedo/symfony3.svg)](https://cloud.docker.com/u/whatwedo/repository/docker/whatwedo/symfony3)
...
|---|---|---|---|
| [`v2.0`, `v2.0-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v2.0/images/symfony3) | Stable | Alpine 3.9 | 7.3 |
| [`v1.7`, `v1.7-[BUILD-DATE]`](https://github.com/whatwedo/docker-base-images/blob/v1.7/images/symfony3.md) | Security fixes only | Ubuntu 14.04 | 7.0 |
...
```
docker run -p 80:80 -v [YOUR-PROJECT-ROOT]:/var/www whatwedo/symfony3:v2-0-dev
```

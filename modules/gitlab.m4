...
RUN sudo -u git -H curl -L --progress https://github.com/gitlabhq/gitlabhq/archive/v8.13.3.zip -o /home/git/gitlab.zip
RUN sudo -u git -H echo '2544449424852acc152c21ee333b8e173c1e90e2  /home/git/gitlab.zip' | shasum -c -
